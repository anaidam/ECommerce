...
class Products(models.Model):
    ...
    def offer_price(self):
        # self means one object - ex-samsung galaxy
    ...
    @property   
    def reviews(self):   # here self is product
...
#     expecte_date = current_date+datetime.timedelta(days=5)
#     expected_deliveydate = models.DateField(default=expecte_date)
